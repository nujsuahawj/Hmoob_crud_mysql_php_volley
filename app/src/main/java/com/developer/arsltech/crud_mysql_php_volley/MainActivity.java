...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://mblaos.000webhostapp.com/show.php";
    Employee employee;
    @Override
    ...
    }//tag nos yog kawg ntawm superclass


    private void deleteData(final String id) {

        StringRequest request = new StringRequest(Request.Method.POST, "https://mblaos.000webhostapp.com/delete.php",
